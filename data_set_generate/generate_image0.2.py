...
def croppy(path1, path2, info):
    ...
    for i in range(len(file_list1)):
        ...
        temp_img = temp_img[info[0]:info[1], info[2]:info[3], :]
...
info = [[254, 590, 285, 690], [230, 494, 343, 660], [14, 480, 90, 455], [325, 658, 330, 673],
        [226, 646, 310, 672], [250, 645, 305, 712], [260, 632, 311, 670], [284, 699, 271, 696]]
