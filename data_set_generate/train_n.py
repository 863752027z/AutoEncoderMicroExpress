...
batch_size = 4
learning_rate = 1e-3
train_path = 'F:/SAMM_FACE_CUT_1/SAMM/train/'
encoder_moudle_path = 'F:/SAMM_FACE_CUT_1/SAMM/encoder_moudle.pkl'
cell_moudle_path = 'F:/SAMM_FACE_CUT_1/SAMM/cell_moudle.pkl'
train_loader = trainLoader(train_path, batch_size, False, 0)
lose_list, encoder_model, cell_model = train(train_loader, learning_rate, num_epochs)
torch.save(encoder_model, encoder_moudle_path)
torch.save(cell_model, cell_moudle_path)
